"""Regression checks for the fathom-parse-log-scope casebook."""
...
from casebook.harness import assert_expected, fathom_parse_log_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(fathom_parse_log_scope_summary(), assert_expected())
